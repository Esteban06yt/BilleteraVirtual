...
public class RecargaViewController {
        ...
        @FXML private AnchorPane ap_recarga;
        ...
        @FXML private Button btn_volver, btn_realizarRecarga, btn_actualizar;
        ...
        @FXML
        void onRealizarRecarga(ActionEvent event) {
                Cuenta cuentaSeleccionada = tb_listaCuentas.getSelectionModel().getSelectedItem();
                if (cuentaSeleccionada == null) {
                        mostrarAlerta("Error", "Selecciona una cuenta para recargar.");
                        return;
                }
