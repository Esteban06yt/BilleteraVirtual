...
public class CrudCuentaViewController {
    ...
    public AnchorPane ap_crudCuenta;
    ...
    public TextField txf_nombreBanco;
    public ComboBox cmb_tipo;
    public Button btn_volver;
    public Button btn_eliminarCuenta;
    public Button btn_agregarCuenta;
    ...
    public void onEliminarCuenta(ActionEvent actionEvent) {
