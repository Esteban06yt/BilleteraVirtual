...
public class DepositoViewController {
        ...
        @FXML private AnchorPane ap_deposito;
        ...
        @FXML private Button btn_volver, btn_realizarDeposito, btn_actualizar;
        ...
        void onRealizarDeposito(ActionEvent event) {
                ...
                if (cuentaSeleccionada == null) {
                        mostrarAlerta("Error", "Selecciona una cuenta para realizar el depósito.");
                        return;
                }
