...
public class TransferenciaViewController {
    ...
    public AnchorPane ap_transferencia;
    ...
    public void onRealizarTransferencia(ActionEvent actionEvent) {
